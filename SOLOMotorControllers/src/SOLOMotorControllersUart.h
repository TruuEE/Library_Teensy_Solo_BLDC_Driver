...
public:
    SOLOMotorControllersUart(unsigned char _deviceAddress = 0, HardwareSerial &_serial = HWSERIAL, SOLOMotorControllers::UartBaudrate _baudrate = SOLOMotorControllers::UartBaudrate::RATE_115200, long _millisecondsTimeout = 50, int _packetFailureTrialAttempts = 5);
